...
namespace Isogeo.AddIn.ViewsModels.Search.AdvancedSearch
{
    public class AdvancedSearchViewModel : MVVMPattern.ViewModelBase
    {
        ...
        public AdvancedSearchViewModel(IMapFunctions mapFunctions, FilterManager filterManager, INetworkManager networkManager)
        {
        ...
        public void InitAdvancedSearchItems()
        {
            ContactFilter = new AdvancedSearchItemViewModel(
                ...
                "contact", _networkManager, _mapFunctions, _filterManager);
            ...
            InspireFilter = new AdvancedSearchItemViewModel(
                ...
                "keyword:inspire-theme", _networkManager, _mapFunctions, _filterManager);
            ...
            FormatFilter = new AdvancedSearchItemViewModel(
                ...
                "format", _networkManager, _mapFunctions, _filterManager);
            ...
            GeographyFilter = new AdvancedSearchItemViewModel(
                ...
                "keyword:isogeo", _networkManager, _mapFunctions, _filterManager);
            ...
            LicenseFilter = new AdvancedSearchItemViewModel(
                ...
                "license", _networkManager, _mapFunctions, _filterManager);
            ...
            CoordinateSystemFilter = new AdvancedSearchItemViewModel(
                ...
                "coordinate-system", _networkManager, _mapFunctions, _filterManager);
            ...
            OwnerMetadataFilter = new AdvancedSearchItemViewModel(
                ...
                "owner", _networkManager, _mapFunctions, _filterManager);
            ...
            ResourceTypeFilter = new AdvancedSearchItemViewModel(
                ...
                "type", _networkManager, _mapFunctions, _filterManager);
        }
    }
}
